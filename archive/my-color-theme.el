  ...
  (color-theme-install
   '(my-color-theme
     (;;(background-color . "AliceBlue")
      ...
      (border-color . "black")
      (cursor-color . "black")
      ;;(foreground-color . "SlateGray4")
      ;;(foreground-color . "black")
      (foreground-color . "gray22")
      (mouse-color . "black"))
     ...
     (font-lock-type-face ((t (:italic t :foreground "blue" :slant italic))))
     ...
     (info-node ((t (:foreground "mediumblue"))))
     (info-xref ((t (:foreground "mediumblue"))))
     (isearch ((t (:background "magenta4" :foreground "lightskyblue1"))))
;;     (isearch-lazy-highlight-face ((t (:background "paleturquoise"))))
     (isearch-lazy-highlight-face ((t (:background "AliceBlue"))))
